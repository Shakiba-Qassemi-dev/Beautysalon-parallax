...
import my from '../assets/images/1.jpg'
import call from '../assets/images/icons8-call-35.png'
import locat from '../assets/images/icons8-location-35.png'
import message from '../assets/images/icons8-mail-35.png'
    ...
    return (
        <>
            <div className='w-full  flex flex-col justify-around items-center'>
                <div className="w-full flex flex-col md:flex-row  md:justify-evenly md:p-10 p-6 gap-4 items-center ">
                    <div className="flex md:justify-center items-center gap-2  w-full">
                        <div>
                            <img src={locat} />
                        </div>
                        <div children="flex flex-col  *:text-black">
                            <h2>Find us</h2>
                    ...
                    <div className="flex md:justify-center items-center gap-2  w-full">
                        ...
                        <div className="flex flex-col *:text-black">
                            <h2>Mail us</h2>
                            <h4>shakibaqassemi@gmail.com</h4>
                        </div>
                    </div>

                </div>
                <div className='bg flex justify-center items-center gap-2'>
                    <h1 className='text-2xl border-b-2 border-black  p-2'>Because you deserve to look amazing</h1>
                    <HiMiniScissors className='text-4xl' />
                </div>
            </div>
